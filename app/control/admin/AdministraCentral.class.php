 ...
 */
class AdministraCentral extends TPage
{
    /**
     * Class constructor
     * Creates the page
    ...
    function __construct()
    {
        ...
        try
        {
            ...
            $indicator1->enableSection('main', ['title' => _t('Provider'),    'icon' => 'user',       'background' => 'orange', 'value' => SystemFornecedor::count()]);
            $indicator2->enableSection('main', ['title' => _t('Payments'),   'icon' => 'users',      'background' => 'blue',   'value' => SystemGroup::count()]);
